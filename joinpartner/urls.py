...
from joinpartner.views import show_vehicle, join_partner, add_product, delete_product, edit_product, manage_partners, approve_partner, reject_partner, pending_approval,rejected, list_partner, delete_partner, show_partner_json, show_vehicle_partner, check_partner_status, create_vehicle_flutter, get_partner, edit_vehicle_flutter, get_detail_vehicle, delete_vehicle_flutter, create_partner_flutter, delete_partner_flutter, edit_partner
...
urlpatterns = [path('vehicles/show/', show_vehicle, name='show_vehicle'),
    ...
    path ('create_partner_flutter/', create_partner_flutter, name='create_partner_flutter'),
    ...
    path('delete_partner_flutter/<str:partner_id>/', delete_partner_flutter, name='delete_partner_flutter'),
    path('edit_partner_flutter/<str:partner_id>/', edit_partner, name='edit_partner_flutter')
    ]